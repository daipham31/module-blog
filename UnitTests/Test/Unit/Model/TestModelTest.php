<?php
namespace Duud\UnitTests\Test\Unit\Model;
...
class TestModelTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->_model = $this->_objectManager->getObject("Duud\UnitTests\Model\TestModel");
    }
    ...
    /**
     * this function tests the result of the square of two numbers
     */
    public function testSquare()
    {
        $result = $this->_model->square(6.0);
        $expectedResult = 36.0;
        $this->assertEquals($expectedResult, $result);
    }
